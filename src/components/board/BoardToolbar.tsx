...
export function BoardToolbar({
  ...
  const item = (
    ...
    >
      ...
      <span className="board-toolbar-label text-[10.5px] font-medium leading-none">{label}</span>
      {badge ? (
    ...
    <div className="board-chrome pointer-events-none absolute left-1/2 top-3 z-40 flex -translate-x-1/2 flex-col items-center gap-1.5">
      ...
      <div className="pointer-events-auto flex items-center gap-0.5 rounded-lg bg-[#1c1c1c]/95 px-1.5 py-1 shadow-[0_10px_34px_rgba(0,0,0,0.55)] ring-1 ring-white/10 backdrop-blur-md">
        ...
        >
          ...
          <span className="board-toolbar-label text-[10.5px] font-medium leading-none">
        ...
        >
          ...
          <span className="board-toolbar-label text-[10.5px] font-medium leading-none">Export</span>
        </button>
        <button
          onClick={onStop}
          className="flex w-[62px] flex-col items-center gap-1 rounded-md px-1 py-1.5 text-[#c9c9c7] transition-colors hover:bg-white/[0.08] hover:text-white"
        >
          ...
          <span className="board-toolbar-label text-[10.5px] font-medium leading-none">Leave</span>
        </button>
      </div>
